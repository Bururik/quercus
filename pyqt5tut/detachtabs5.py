...
class DetachableTabWidget(QtWidgets.QTabWidget):
    def __init__(self, parent=None):
        ...
        QtWidgets.QApplication.instance().aboutToQuit.connect(self.closeDetachedTabs) # @UndefinedVariable
    ...
    @QtCore.pyqtSlot(QString, int, QtCore.QPoint)
    ...
    class DetachedTab(QtWidgets.QMainWindow):
        onCloseSignal = pyqtSignal(QtWidgets.QWidget, 'QString', QtGui.QIcon)
        onDropSignal = pyqtSignal('QString', QtCore.QPoint)
    ...
    class TabBar(QtWidgets.QTabBar):
        ...
        detachedTabDropSignal = pyqtSignal('QString', int, QtCore.QPoint)
